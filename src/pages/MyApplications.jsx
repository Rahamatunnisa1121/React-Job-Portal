  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        // ✅ filter only this developer's applications
        const filtered = data.filter((app) => app.applicantId === user.id);
      ...
      <div className="container mx-auto py-12 px-6 max-w-6xl">
        ...
        {filteredApplications.length > 0 ? (
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className={`px-4 py-2 rounded-full text-sm font-semibold border ${
                      ...
                      {!["approved", "rejected", "pending"].includes(app.status) && app.status}
                    </div>
                  </div>
          ...
          <div className="text-center py-12 bg-white rounded-xl shadow-md">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No {filterStatus} applications</h3>
